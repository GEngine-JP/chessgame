...
{
    public class WestRectMode : MonoBehaviour
    {
        public static WestRectMode Instance;
        ...
        public void OnMouseDown()
        {
            ...
            App.GetGameData<GlobalData>().BetPosSelf = 2;
            App.GetRServer<GameServer>().UserBet(2, (int)App.GetGameData<GlobalData>().I64ChoumaValue[App.GetGameData<GlobalData>().ChouMaType]);
            App.GameData.GStatus = GameStatus.PlayAndConfine;
            //BetMode.Instance.InstanceCoinDemo(GameConfig.Instance.iChouMaType, 2, App.GetGameData<GlobalData>().CurrentUser.Seat);
        }
    }
}
