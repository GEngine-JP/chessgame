...
{
    public class NorthRectMode : MonoBehaviour
    {
        public static NorthRectMode Instance;
        ...
        public void OnMouseDown()
        {
            ...
            App.GetGameData<GlobalData>().BetPosSelf = 3;
            App.GetRServer<GameServer>().UserBet(3, (int)App.GetGameData<GlobalData>().I64ChoumaValue[App.GetGameData<GlobalData>().ChouMaType]);
