...
namespace Assets.Scripts.Game.jh.ui
{
    public class JhPlayer : YxBaseGamePlayer
    {
        ...
        public EventDelegate OnUpdateTimeCall;

        public GameObject MoveGold;

        public GameObject ChooseHeadIcon;

        public JhAllBeat AllBeat;
        ...
        protected void Update()
        {
            ...
            if (IsStart)
            {
                ...
                {
                    if (OnUpdateTimeCall!=null&&OnUpdateTimeCall.isEnabled)
                    {
                        OnUpdateTimeCall.parameters[0] = new EventDelegate.Parameter(ToTalTime - PassTime);
                        OnUpdateTimeCall.Execute();
                    }
                }
            }
        }
        ...
        public void SetBeat(int gold)
        {
            if (AllBeat != null)
            {
                AllBeat.SetBeat(gold);
            }
        }
    }
}
