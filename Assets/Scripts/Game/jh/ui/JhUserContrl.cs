...
namespace Assets.Scripts.Game.jh.ui
{
    public class JhUserContrl : MonoBehaviour
    {
        ...
        public readonly int OnTrun = KanPai | BiPai | Qipai;

        public readonly int NotTrun = GenZhu | JiaZhu | BiPai | KanPai | Qipai;
        ...
        public void OnTrunShow(bool isLook,bool isCompare,bool isGiveUp)
        {
            int wei = OnTrun;
            if (isLook)
            {
...
//            SetLiangPai(false);
        ...
        public void ZiDongGenZhuShow(bool iszidong)
        {
            SetZiDongGenZhu(iszidong);
        }
        ...
        public void GzyzShow(bool isLook,bool isGiveUp)
        {
            int wei =  KanPai | JiaZhu | GenZhu | ZiDongGenZhu | Qipai;
            if (isLook)
            {
                wei |= KanPai;
                wei ^= KanPai;
