...
namespace Assets.Scripts.Game.rbwar
{
    ...
    public class RoadNodeTable
    {
        ...
        /// <returns></returns>
        public RoadNodeTable(int[] result, int lineHeight)
        {
            CurrentX = 1;
            CurrentY = 1;
            StartX = 1;
        ...
        /// <returns></returns>
        public bool AddSingleItem(int value)
        {
            bool returnState = InsertNode(value == 0);
            return returnState;
        }
    ...
    public class RoadNode 
    {
        ...
        public RoadNode(int x, int y, bool bRed)
        {
            X = x;
            Y = y;
            IsRed = bRed;
