    ...
    public class Plane2 : MonoBehaviour
    {
        ...
        public void OnMouseDown()
        {
            ...
            if (Plane5.Instance.IsPointerOverUIObject())
                return;
            if (gdata.Allow[2]!=0&&gdata.GoldNum[UserInfoUI.Instance.GameConfig.CoinType] > gdata.Allow[2])
            ...
            App.GetRServer<GameServer>().UserBet(2, gdata.GoldNum[UserInfoUI.Instance.GameConfig.CoinType]);
