    ...
    public class Plane4 : MonoBehaviour
    {
        ...
        public void OnMouseDown()
        {
            ...
            if (Plane5.Instance.IsPointerOverUIObject())
                return;
            if (gdata.Allow[4]!=0&&gdata.GoldNum[UserInfoUI.Instance.GameConfig.CoinType] > gdata.Allow[4])
            ...
            App.GetRServer<GameServer>().UserBet(4, gdata.GoldNum[UserInfoUI.Instance.GameConfig.CoinType]);
