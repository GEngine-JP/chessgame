    ...
    public class Plane7 : MonoBehaviour {
        ...
        public void OnMouseDown()
        {
            ...
            if (Plane5.Instance.IsPointerOverUIObject())
                return;
            if ( gdata.Allow[7]!=0&&gdata.GoldNum[UserInfoUI.Instance.GameConfig.CoinType] > gdata.Allow[7])
            {
            ...
            App.GetRServer<GameServer>().UserBet(7, gdata.GoldNum[UserInfoUI.Instance.GameConfig.CoinType]);
