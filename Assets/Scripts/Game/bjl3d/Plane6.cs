    ...
    public class Plane6 : MonoBehaviour
    {
        ...
        public void OnMouseDown()
        {
            ...
            if (Plane5.Instance.IsPointerOverUIObject())
                return;
            if (gdata.Allow[6]!=0&&gdata.GoldNum[UserInfoUI.Instance.GameConfig.CoinType] > gdata.Allow[6])
            ...
            App.GetRServer<GameServer>().UserBet(6, gdata.GoldNum[UserInfoUI.Instance.GameConfig.CoinType]);
