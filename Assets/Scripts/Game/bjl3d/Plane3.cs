    ...
    public class Plane3 : MonoBehaviour
    {
        ...
        public void OnMouseDown()
        {
            ...
            if (Plane5.Instance.IsPointerOverUIObject())
                return;
            if (gdata.Allow[3]!=0&&gdata.GoldNum[UserInfoUI.Instance.GameConfig.CoinType] > gdata.Allow[3])
            {
            ...
            App.GetRServer<GameServer>().UserBet(3, gdata.GoldNum[UserInfoUI.Instance.GameConfig.CoinType]);
