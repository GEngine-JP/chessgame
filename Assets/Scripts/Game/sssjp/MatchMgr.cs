...
namespace Assets.Scripts.Game.sssjp
{
    public class MatchMgr : MonoBehaviour
    {
        ...
        /// 特殊牌型整体特效
        /// </summary>
        [SerializeField] protected ParticleSystem SpecialParticle;

        /// <summary>
        /// 特殊牌型的文字特效
        /// </summary>
        [SerializeField] protected ParticleSystem SpecialLabelParticle;
        ...
        [SerializeField] protected List<Texture> SpecialTextureList;
