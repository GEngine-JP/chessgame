...
namespace Assets.Scripts.Game.Mahjong3D.Standard
{
    public class TitleStyleChangeCard : TitleStyleBase
    {
        ...
        private void Awake()
        {
            GameCenter.EventHandle.Subscriber((int)UIEventProtocol.HideChangeCardTip, HideChangeCardTip);
            GameCenter.EventHandle.Subscriber((int)UIEventProtocol.ChangeErrorTip, ChangeErrorTip);
        }
