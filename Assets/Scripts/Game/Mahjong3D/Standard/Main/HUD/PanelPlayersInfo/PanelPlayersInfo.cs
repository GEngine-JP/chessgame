...
namespace Assets.Scripts.Game.Mahjong3D.Standard
{
    ...
    public class PanelPlayersInfo : UIPanelBase, IPlaybackCycle
    {
        ...
        private void Awake()
        {
            ...
            Event.Subscriber((int)UIEventProtocol.UpdateCurrOpPlayer, UpdateCurrOpPlayer);
            Event.Subscriber((int)UIEventProtocol.PlayerReady, OnPlayerReady);
            Event.Subscriber((int)UIEventProtocol.PlayAddScore, PlaySetScore);
            Event.Subscriber((int)UIEventProtocol.PlayerJoin, OnPlayerJoin);
            Event.Subscriber((int)UIEventProtocol.PlayerOut, OnPlayerOut);
            Event.Subscriber((int)UIEventProtocol.SetBanker, OnSetBanker);
            Event.Subscriber((int)UIEventProtocol.OnTing, OnTing);
            //扩展
