namespace Assets.Scripts.Game.Mahjong3D.Standard
{
    public class ProtocolKey
    {
        ...
        public const string Keybank = "bank0";
        public const string KeyTing = "hasTing";
        ...
        public const string WinTime = "win"; //赢的局数       
        public const string LostTime = "lost"; //输的局数      
        public const string TotalTime = "total";//一共的局数 
        public const string IsBreaked = "isBreaked";//是否短线
        ...
        public const string KeySaiziList = "saizilist";
        public const string KeyBaoIndexList = "baoindexlist";
        public const string KeyHuangZhuang = "tip_num";
    }
}