...
     *历史记录: 
    */
    public class AppInfo
    {
        ...
        public const string StartCfgUrl = "";
        ...
        public const string GameResUrl = "http://cdn.18yb.com/opensource/res/games/windows/";
        public const string SkinNames = "hall|gamelist||rulelist";
        public const bool NeedTimeOutTip = false;
        public const bool IsDeve = false;
        ...
        public const string IsDebug = "10";
